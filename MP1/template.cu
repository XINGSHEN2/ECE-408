...
// int vecAdd(float *in1, float *in2, float *out, int len) {
//   //@@ Insert code to implement vector addition here
//   dim3 DimGrid(ceil(len/256),1,1);
//   if (0 != (len % 256)) {DimGrid.x++;}
//   dim3 DimBlock(256,1,1);
//   vecAddKernel<<<DimGrid, DimBlock>>>(in1, in2, out, len);
// }
...
int main(int argc, char **argv) {
  ...
  //wbLog(TRACE, "The input1 is ", *deviceInput1);

  //wbLog(TRACE, "The input2 is ", *deviceInput2);
  ...
  //wbLog(TRACE, "The output is ", *deviceOutput);
